...
DNN 作为推荐系统领域早期代表性的模型。在测试性能时，我们以 **单位时间内能够完成训练的样本行数量（example/sec）** 作为训练期间的吞吐性能。在其它框架中，默认也均采用相同的计算方式。
...
- 测试(WORKER和SERVER数量相等)
  ...
  |:-----:|:-----:|:-----:|
  | 4x4   | <sup>378599</sup>  | <sup>13507</sup> |
  | 8x8   | <sup>736955</sup>  | <sup>22862</sup> |
  | 16x16 | <sup>1448210</sup>  | <sup>10703</sup> |
  | 32x32 | <sup>2553503</sup> | <sup>21407</sup> |
