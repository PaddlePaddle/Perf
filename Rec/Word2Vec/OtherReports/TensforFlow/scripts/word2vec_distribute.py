...
flags.DEFINE_string("model_output_dir", 'model', "Directory to write the model and "
                    "training summaries.")
flags.DEFINE_string("log_dir", 'log', "Directory to write log file")
            ...
            with tf.train.MonitoredTrainingSession(master=server.target,
                ...
                for epoch in xrange(FLAGS.epochs_to_train):
                    ...
                    for examples_, labels_, in get_batch(word2vec_reader.train(), FLAGS.batch_size):
                        ...
                        if batch_id % 1000 == 0:
                            logger.info("Epoch %4d Step %8d local step %8d loss = %6.2f" % (
                    ...
                    logger.info(
                        "Epoch: {} total time: {} ips: {} word/s".format(epoch, now - start_time, speed))
