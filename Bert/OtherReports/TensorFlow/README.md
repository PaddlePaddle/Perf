...
- [32卡 bs=32、FP32](./logs/tf_bert_pretraining_lamb_base_without_gradacc_fp32_bs32_gpu32.log)
- [32卡 bs=48、FP32](./logs/tf_bert_pretraining_lamb_base_without_gradacc_fp32_bs48_gpu32.log)
- [32卡 bs=64、AMP](./logs/tf_bert_pretraining_lamb_base_without_gradacc_fp16_bs64_gpu32.log)
- [32卡 bs=96、AMP](./logs/tf_bert_pretraining_lamb_base_without_gradacc_fp16_bs96_gpu32.log)